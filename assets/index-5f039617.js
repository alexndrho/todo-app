 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const co=Rk;function c0(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:vh,automaticDataCollectionEnabled:!1},e),i=r.name;if(typeof i!="string"||!i)throw Mn.create("bad-app-name",{appName:String(i)});if(n||(n=EI()),!n)throw Mn.create("no-options");const s=rl.get(i);if(s){if(nl(n,s.options)&&nl(r,s.config))return s;throw Mn.create("duplicate-app",{appName:i})}const o=new UI(i);for(const l of wh.values())o.addComponent(l);const a=new $k(n,r,o);return rl.set(i,a),a}function h0(t=vh){const e=rl.get(t);if(!e&&t===vh)return c0();if(!e)throw Mn.create("no-app",{appName:t});return e}function bn(t,e,n){var r;let i=(r=Ak[t])!==null&&r!==void 0?r:t;n&&(i+=`-${n}`);const s=i.match(/\s|\//),o=e.match(/\s|\//);if(s||o){const a=[`Unable to register library "${i}" with version "${e}":`];s&&a.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Cr.warn(a.join(" "));return}Ei(new Tr(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xk="firebase-heartbeat-database",Pk=1,zs="firebase-heartbeat-store";let ec=null;function d0(){return ec||(ec=JI(xk,Pk,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(zs)}}}).catch(t=>{throw Mn.create("idb-open",{originalErrorMessage:t.message})})),ec}async function Ok(t){try{return(await d0()).transaction(zs).objectStore(zs).get(f0(t))}catch(e){if(e instanceof dt)Cr.warn(e.message);else{const n=Mn.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Cr.warn(n.message)}}}async function Nm(t,e){try{const r=(await d0()).transaction(zs,"readwrite");return await r.objectStore(zs).put(e,f0(t)),r.done}catch(n){if(n instanceof dt)Cr.warn(n.message);else{const r=Mn.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});Cr.warn(r.message)}}}function f0(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vk(t){Ei(new Tr("platform-logger",e=>new tk(e),"PRIVATE")),Ei(new Tr("heartbeat",e=>new bk(e),"PRIVATE")),bn(yh,Am,t),bn(yh,Am,"esm2017"),bn("fire-js","")}Vk("");var Bk="firebase",zk="9.19.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _n extends go{constructor(){super("facebook.com")}static credential(e){return Rr._fromParams({providerId:_n.PROVIDER_ID,signInMethod:_n.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return _n.credentialFromTaggedObject(e)}static credentialFromError(e){return _n.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return _n.credential(e.oauthAccessToken)}catch{return null}}}_n.FACEBOOK_SIGN_IN_METHOD="facebook.com";_n.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class In extends go{constructor(){super("github.com")}static credential(e){return Rr._fromParams({providerId:In.PROVIDER_ID,signInMethod:In.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return In.credentialFromTaggedObject(e)}static credentialFromError(e){return In.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return In.credential(e.oauthAccessToken)}catch{return null}}}In.GITHUB_SIGN_IN_METHOD="github.com";In.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qw(t){var e,n;return((n=(((e=t==null?void 0:t.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||n===void 0?void 0:n.stringValue)==="server_timestamp"}function Yw(t){const e=t.mapValue.fields.__previous_value__;return Qw(e)?Yw(e):e}function Js(t){const e=zn(t.mapValue.fields.__local_write_time__.timestampValue);return new Ee(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const AA=new Ie(O.comparator);function fn(){return AA}const a1=new Ie(O.comparator);function ls(...t){let e=a1;for(const n of t)e=e.insert(n.key,n);return e}function l1(t){let e=a1;return t.forEach((n,r)=>e=e.insert(n,r.overlayedDocument)),e}function dr(){return _s()}function u1(){return _s()}function _s(){return new Ui(t=>t.toString(),(t,e)=>t.isEqual(e))}const NA=new Ie(O.comparator),DA=new Se(O.comparator);function W(...t){let e=DA;for(const n of t)e=e.add(n);return e}const $A=new Se(Y);function c1(){return $A}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lf{constructor(e,n,r,i){this.targetId=e,this.fromCache=n,this.Vi=r,this.Si=i}static Di(e,n){let r=W(),i=W();for(const s of n.docChanges)switch(s.type){case 0:r=r.add(s.doc.key);break;case 1:i=i.add(s.doc.key)}return new Lf(e,n.fromCache,r,i)}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Je{constructor(e,n,r){this.converter=n,this._key=r,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Fn(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new Je(this.firestore,e,this._key)}}class Xn{constructor(e,n,r){this.converter=n,this._query=r,this.type="query",this.firestore=e}withConverter(e){return new Xn(this.firestore,e,this._query)}}class Fn extends Xn{constructor(e,n,r){super(e,n,ou(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new Je(this.firestore,null,new O(e))}withConverter(e){return new Fn(this.firestore,e,this._path)}}function RD(t,e,...n){if(t=_e(t),q1("collection","path",e),t instanceof yu){const r=te.fromString(e,...n);return Ug(r),new Fn(t,null,r)}{if(!(t instanceof Je||t instanceof Fn))throw new D(E.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(te.fromString(e,...n));return Ug(r),new Fn(t.firestore,null,r)}}function Na(t,e,...n){if(t=_e(t),arguments.length===1&&(e=Gw.A()),q1("doc","path",e),t instanceof yu){const r=te.fromString(e,...n);return Fg(r),new Je(t,null,new O(r))}{if(!(t instanceof Je||t instanceof Fn))throw new D(E.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(te.fromString(e,...n));return Fg(r),new Je(t.firestore,t instanceof Fn?t.converter:null,new O(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function WD(t){t=_t(t,Je);const e=_t(t.firestore,Wn);return ID(vu(e),t._key).then(n=>oE(e,t,n))}class ip extends BD{constructor(e){super(),this.firestore=e}convertBytes(e){return new Ai(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new Je(this.firestore,null,n)}}function HD(t){t=_t(t,Xn);const e=_t(t.firestore,Wn),n=vu(e),r=new ip(e);return eE(t._query),kD(n,t._query).then(i=>new sE(e,r,t,i))}function qD(t,e,n,...r){t=_t(t,Je);const i=_t(t.firestore,Wn),s=Yf(i);let o;return o=typeof(e=_e(e))=="string"||e instanceof wu?LD(s,"updateDoc",t._key,e,n,r):OD(s,"updateDoc",t._key,e),sp(i,[o.toMutation(t._key,Pt.exists(!0))])}function Wg(t){return sp(_t(t.firestore,Wn),[new Nf(t._key,Pt.none())])}function GD(t,e){const n=_t(t.firestore,Wn),r=Na(t),i=zD(t.converter,e);return sp(n,[PD(Yf(t.firestore),"addDoc",r._key,i,t.converter!==null,{}).toMutation(r._key,Pt.exists(!1))]).then(()=>r)}function KD(t,...e){var n,r,i;t=_e(t);let s={includeMetadataChanges:!1},o=0;typeof e[o]!="object"||Bg(e[o])||(s=e[o],o++);const a={includeMetadataChanges:s.includeMetadataChanges};if(Bg(e[o])){const d=e[o];e[o]=(n=d.next)===null||n===void 0?void 0:n.bind(d),e[o+1]=(r=d.error)===null||r===void 0?void 0:r.bind(d),e[o+2]=(i=d.complete)===null||i===void 0?void 0:i.bind(d)}let l,u,c;if(t instanceof Je)u=_t(t.firestore,Wn),c=ou(t._key.path),l={next:d=>{e[o]&&e[o](oE(u,t,d))},error:e[o+1],complete:e[o+2]};else{const d=_t(t,Xn);u=_t(d.firestore,Wn),c=d._query;const h=new ip(u);l={next:m=>{e[o]&&e[o](new sE(u,h,d,m))},error:e[o+1],complete:e[o+2]},eE(t._query)}return function(d,h,m,v){const y=new qf(v),S=new Wf(h,y,m);return d.asyncQueue.enqueueAndForget(async()=>Bf(await Il(d),S)),()=>{y.yc(),d.asyncQueue.enqueueAndForget(async()=>zf(await Il(d),S))}}(vu(u),c,a,l)}function sp(t,e){return function(n,r){const i=new nn;return n.asyncQueue.enqueueAndForget(async()=>uD(await _D(n),r,i)),i.promise}(vu(t),e)}function oE(t,e,n){const r=n.docs.get(e._key),i=new ip(t);return new iE(t,i,e._key,r,new us(n.hasPendingWrites,n.fromCache),e.converter)}(function(t,e=!0){(function(n){bi=n})(co),Ei(new Tr("firestore",(n,{instanceIdentifier:r,options:i})=>{const s=n.getProvider("app").getImmediate(),o=new Wn(new JR(n.getProvider("auth-internal")),new nA(n.getProvider("app-check-internal")),function(a,l){if(!Object.prototype.hasOwnProperty.apply(a.options,["projectId"]))throw new D(E.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Zs(a.options.projectId,l)}(s,r),s);return i=Object.assign({useFetchStreams:e},i),o._setSettings(i),o},"PUBLIC").setMultipleInstances(!0)),bn(lg,"3.10.0",t),bn(lg,"3.10.0","esm2017")})();const QD={apiKey:"AIzaSyBKoWeEC52EDQ-ujheSQ_AvV3rKNIiaHpE",authDomain:"todo-app-e1f61.firebaseapp.com",projectId:"todo-app-e1f61",storageBucket:"todo-app-e1f61.appspot.com",messagingSenderId:"578274698508",appId:"1:578274698508:web:cd205e6b6f63a36c489529",measurementId:"G-DW8ZX8KBZZ"},aE=c0(QD),ti=GC(aE),YD=new Qt,ua=ND(aE),{styled:op}=Pr,XD=op("nav",{width:"100%",height:"3.25rem",marginBottom:"1.25rem",display:"flex",justifyContent:"space-around",borderBottom:"$border"}),mc=op("button",{width:"6rem",height:"auto",background:"none",color:"$fg",border:"none",fontFamily:"$default",fontWeight:"$bold",fontSize:"$md",position:"relative"}),gc=op("div",{content:"",width:"100%",height:0,borderRadius:"0.25rem 0.25rem 0 0",background:"$blue",display:"block",position:"absolute",left:0,bottom:0,transition:"0.1s"});var Rt=(t=>(t[t.All=0]="All",t[t.Active=1]="Active",t[t.Completed=2]="Completed",t))(Rt||{});const JD=({mode:t,onModeChange:e})=>{const n=(r,i)=>r===i?{height:"0.25rem"}:{height:0};return lt(XD,{children:[lt(mc,{onClick:()=>e("all"),children:["All ",j(gc,{style:n(t,0)})]}),lt(mc,{onClick:()=>e("active"),children:["Active ",j(gc,{style:n(t,1)})]}),lt(mc,{onClick:()=>e("completed"),children:["Completed ",j(gc,{style:n(t,2)})]})]})},{styled:ap}=Pr,ZD=ap("section",{width:"100%",margin:"1rem 0 1.5rem 0",height:"3.5rem",display:"flex"}),e$=ap("input",{height:"100%",marginRight:"1.75rem",padding:"0.85rem",flexGrow:6,border:"$border",borderRadius:"$borderRadius",outline:0,fontFamily:"$default",fontSize:"$md",color:"$lightBlack",fontWeight:"$regular",caretColor:"$blue"}),t$=ap("button",{height:"100%",flexGrow:1,background:"$blue",border:"none",borderRadius:"$borderRadius",fontFamily:"$default",fontSize:"$md",fontWeight:"$bold",color:"White","&:hover":{background:"$lightBlue"}}),n$=({isHide:t,onAddDetail:e})=>{const n=Re.useRef(null),r=()=>{var i,s;((i=n.current)==null?void 0:i.value)===""||((s=n.current)==null?void 0:s.value)===void 0||(e(n.current.value),n.current.value="")};return lt(ZD,{style:{display:t?"none":"flex"},children:[j(e$,{ref:n,type:"text",placeholder:"add details",onKeyDown:i=>{i.key==="Enter"&&r()}}),j(t$,{onClick:r,children:"Add"})]})},r$="/todo-app/assets/trash-bin-fde058b4.png",{styled:Su}=Pr,i$=Su("section",{width:"100%",height:"1.85rem",margin:"1.25rem 0",display:"flex",alignItems:"center"}),s$=Su("input",{appearance:"none",backgroundColor:"none",margin:0,color:"$blue",height:"100%",aspectRatio:"1 / 1",border:"$border",borderRadius:"0.25em",display:"grid",placeContent:"center",cursor:"pointer","&::before":{content:"",width:"1.5em",height:"1.5em",transform:"scale(0)",transition:"120ms transform ease-in-out",boxShadow:"inset 100em 100em #007fff"},"&:checked::before":{transform:"scale(1)"}}),o$=Su("label",{marginLeft:"0.5rem",fontSize:"$l",userSelect:"none"}),a$=Su("img",{height:"90%",margin:"0 0.75rem 0 auto",cursor:"pointer",userSelect:"none"}),yc=({task:t,onCompleted:e,onDelete:n})=>{const r=Re.useRef(null);return Re.useEffect(()=>{var i;t.isCompleted&&((i=r.current)==null?void 0:i.checked)!==void 0&&(r.current.checked=t.isCompleted)},[]),lt(i$,{children:[j(s$,{type:"checkbox",ref:r,id:t.id,onClick:()=>e(t.id)}),j(o$,{htmlFor:t.id,style:{textDecoration:t.isCompleted?"line-through":"none"},children:t.description}),j(a$,{draggable:"false",src:r$,alt:"trash bin",onClick:()=>n(t.id)})]})},l$="/todo-app/assets/trash-bin-white-ca0dceee.png",{styled:lE}=Pr,u$=lE("button",{width:"9em",height:"100%",marginLeft:"auto",background:"$red",border:"none",borderRadius:"$delete",fontFamily:"$default",fontSize:"$md",fontWeight:"$bold",color:"White",display:"flex",justifyContent:"center",alignItems:"center","&:hover":{background:"$lightRed"}}),c$=lE("img",{height:"1.25em",marginRight:"0.35em"}),h$=({onDelete:t})=>lt(u$,{onClick:t,children:[j(c$,{src:l$}),"Delete All"]}),{styled:Bi}=Pr,d$=Bi("div",{width:"$conWidth",height:"100%",paddingBottom:"2rem"}),f$=Bi("header",{position:"relative",width:"100%",height:"6.5rem",marginBottom:"0.25rem",display:"flex",justifyContent:"center",alignItems:"center"}),p$=Bi("h1",{width:"auto",height:"auto",fontFamily:"$title",fontSize:"$xl",fontWeight:"$bolder",color:"$fg",userSelect:"none"}),m$=Bi("button",{position:"absolute",right:"0",width:"5.5rem",height:"2.8rem",fontSize:"0.85rem",fontFamily:"$default",fontWeight:"500",border:"none",background:"$btnGray",color:"$btnGrayColor",borderRadius:"0.5rem","&:active":{background:"$btnLightGray"}}),g$=Bi("main",{width:"100%",height:"auto"}),y$=Bi("section",{width:"100%",height:"2.85rem"}),v$=()=>{var v;const[t,e]=Re.useState(Rt.All),[n,r]=Re.useState([]),i=(v=ti.currentUser)==null?void 0:v.uid,s=RD(ua,"users",`${i}`,"todos");Re.useEffect(()=>{const y=UD(s,VD("description"));KD(y,S=>{r(S.docs.map(p=>({...p.data(),id:p.id})))})},[]);const o=async()=>{try{await PT(ti)}catch(y){y instanceof dt&&console.log(y.code,": ",y.message)}},a=y=>{y==="all"?e(Rt.All):y==="active"?e(Rt.Active):y==="completed"&&e(Rt.Completed)},l=async y=>{try{await GD(s,{description:y,isCompleted:!1})}catch(S){console.error(S)}},u=async y=>{const S=Na(ua,"users",`${i}`,"todos",y);try{const p=await WD(S);p.exists()&&await qD(S,{isCompleted:!p.data().isCompleted})}catch(p){console.error(p)}},c=async y=>{const S=Na(ua,"users",`${i}`,"todos",y);try{await Wg(S)}catch(p){console.error(p)}},d=()=>{switch(t){case Rt.All:return n.map(y=>j(yc,{task:y,onCompleted:u,onDelete:c},y.id));case Rt.Active:return n.map(y=>y.isCompleted?j(hp,{}):j(yc,{task:y,onCompleted:u,onDelete:c},y.id));case Rt.Completed:return n.map(y=>y.isCompleted?j(yc,{task:y,onCompleted:u,onDelete:c},y.id):j(hp,{}))}},h=()=>{let y=!1;return n.forEach(S=>{S.isCompleted&&(y=!0)}),y},m=async()=>{try{(await HD(s)).forEach(S=>{if(!S.data().isCompleted)return;const p=Na(ua,"users",`${i}`,"todos",`${S.id}`);(async()=>{try{await Wg(p)}catch(g){console.error(g)}})()})}catch(y){console.error(y)}};return lt(d$,{children:[lt(f$,{children:[j(p$,{children:"#todo"}),j(m$,{onClick:o,children:"Sign Out"})]}),lt(g$,{children:[j(JD,{mode:t,onModeChange:a}),j(n$,{isHide:!(t===Rt.All||t===Rt.Active),onAddDetail:l}),d()]}),j(y$,{style:{display:t===Rt.Completed&&h()?"block":"none"},children:j(h$,{onDelete:m})})]})},w$="/todo-app/assets/google-icon-cc30a73d.png",{styled:mn}=Pr,E$=mn("main",{width:"100%",height:"100%",display:"flex",justifyContent:"center",alignItems:"center"}),S$=mn("form",{width:"$conWidthLogin",height:"100%",display:"flex",flexDirection:"column",justifyContent:"center"}),_$=mn("h1",{margin:0,fontSize:"2rem",color:"$black"}),Hg=mn("label",{marginTop:"0.5rem",color:"Gray",fontSize:"$md",fontWeight:"400"}),qg=mn("input",{width:"auto",height:"2.5rem",padding:"0.65rem",color:"$black",fontSize:"$l",border:"$border",borderRadius:"0.35rem"}),I$=mn("div",{margin:"0.75rem 0 0.5rem 0",width:"100%",height:"auto",display:"flex"}),vc=mn("button",{height:"3rem",background:"none",borderRadius:"0.35rem",border:"none",fontSize:"$md",fontFamily:"$default",fontWeight:"500",color:"$black",variants:{color:{blue:{background:"$blue",color:"white","&:active":{background:"$lightBlue"}},gray:{background:"$btnGray",color:"$btnGrayColor","&:active":{background:"$btnLightGray"}}}}}),k$=mn("img",{height:"1.5rem",marginRight:"0.5rem"}),Gg=mn("p",{fontSize:"$md",color:"$red"}),T$=({setIsLogin:t})=>{const[e,n]=Re.useState(""),[r,i]=Re.useState(""),[s,o]=Re.useState(""),[a,l]=Re.useState("");return Re.useEffect(()=>{xT(ti,h=>{t(!!h)})},[]),j(E$,{children:lt(S$,{onSubmit:h=>h.preventDefault(),children:[j(_$,{children:"Login"}),j(Hg,{htmlFor:"email",children:"Email"}),j(qg,{id:"email",type:"email",onChange:h=>n(h.target.value),css:{border:s===""?"$border":"$borderError"}}),j(Gg,{children:s}),j(Hg,{htmlFor:"password",children:"Password"}),j(qg,{id:"password",type:"password",onChange:h=>i(h.target.value),css:{border:a===""?"$border":"$borderError"}}),j(Gg,{children:a}),lt(I$,{children:[j(vc,{color:"gray",type:"button",onClick:async()=>{try{await AT(ti,e,r),o(""),l("")}catch(h){h instanceof dt&&(console.log(h.code,": ",h.message),h.code==="auth/invalid-email"?o("Invalid Email!"):h.code==="auth/email-already-in-use"?o("Email is already in use!"):o(""),h.code==="auth/missing-password"?l("Password is missing!"):h.code==="auth/weak-password"?l("Password should be at least 6 characters!"):l(""))}},css:{flexGrow:1,marginRight:"0.5rem"},children:"Sign Up"}),j(vc,{color:"blue",type:"submit",onClick:async()=>{try{await NT(ti,e,r),o(""),l("")}catch(h){h instanceof dt&&(console.log(h.code,": ",h.message),h.code==="auth/invalid-email"?o("Invalid email!"):h.code==="auth/user-not-found"?o("User not found!"):h.code==="auth/too-many-requests"?o("Access to this account has been temporarily disabled due to many failed login attempts."):o(""),h.code==="auth/missing-password"?l("Password is missing!"):h.code==="auth/wrong-password"?l("Incorrect password!"):l(""))}},css:{flexGrow:1},children:"Log In"})]}),lt(vc,{color:"gray",type:"button",onClick:async()=>{try{await rC(ti,YD)}catch(h){h instanceof dt&&console.log(h.code,": ",h.message)}},css:{display:"flex",justifyContent:"center",alignItems:"center"},children:[j(k$,{src:w$,alt:"Google icon"}),"Sign in with Google"]})]})})};const C$=()=>{const[t,e]=Re.useState(!1),n=r=>e(r);return j(Re.Fragment,{children:t?j(v$,{}):j(T$,{setIsLogin:n})})};wc.createRoot(document.getElementById("root")).render(j(nr.StrictMode,{children:j(C$,{})}));
